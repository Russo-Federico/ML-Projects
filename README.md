...
**1- Computer Vision and Image Processing**  *- folder: /ComputerVision*:
  <br>Garbage image processing: infer into which category each image falls into
  - Used custom CNN
...
**3- Time Series Forecasting**  *- folder: /TimeSeriesForecasting*:
